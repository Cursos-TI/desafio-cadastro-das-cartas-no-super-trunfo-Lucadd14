...
int main(){
    ...
    char estado[50] = "amazonas" - "para";
    char codigo[30] = "Am1" - "pr2";
    char nomedacidade[100] = "manaus" - "belem";
    unsigned int populacao = "2300000" - "2000000";
    char area[15]=" 2000000" - "1980000";
    long int pib = "103500000" - "100000000";
    int numerosdepontosturisticos = "50" - "42";
